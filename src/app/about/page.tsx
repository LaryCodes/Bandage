...
import girl from "@/app/images/first.png";
import bg from "@/images/media bg-cover.png";
import user1 from "@/app/images/one.png";
import user2 from "@/app/images/two.png";
import user3 from "@/app/images/third.png";
import cm1 from "@/app/images/Vector (5).png";
import cm2 from "@/app/images/Vector (6).png";
import cm3 from "@/app/images/Vector (7).png";
import cm4 from "@/app/images/Vector (8).png";
import cm5 from "@/app/images/Vector (9).png";
import cm6 from "@/app/images/Vector (10).png";
import girl2 from "@/app/images/third.png"
import video from "@/app/images/second.png"
                ...
                <div className="relative flex flex-col gap-8">
                    ...
                    <div className="w-full max-w-[1050px] mx-auto flex flex-col items-start lg:gap-[80px] gap-[40px] py-[112px] sm:mb-[50px]">
                        <div className="flex flex-col lg:flex-row items-center gap-[30px] w-full lg:w-[1044px] lg:h-[321px]">
                            ...
                            <Image src={girl} alt="girl" className="items-right lg:block hidden lg:left-[-1px] top-[300px] lg:top-[0px]" />
                        </div>
                        {/* <div>
                             Column 2 
                        </div> */}
                ...
                <section className="relative w-full h-[636px] flex bg-[#2A7CC7] justify-center items-center mt-[-30px]">
                    ...
                    <div className="md:w-1/2 h-full relative">
                        <Image
                            ...
                            className="absolute w-[480px] h-[640px] left-[150px] inset-0 object-cover"
                        />
                    </div>
